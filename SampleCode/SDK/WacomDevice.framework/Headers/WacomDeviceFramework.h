...
//! @function getESerialNumber
//! @returns returns the E-Serial number.
...
//! @function getMacAddress
//! @returns the Bluetooth address in string form.
- (NSString *)getMacAddress;
...
//! @function getModel
//! @returns the enum for the device model.
...
//! @discussion clear the list of previously connected devices. This will disconnect any connected device.
