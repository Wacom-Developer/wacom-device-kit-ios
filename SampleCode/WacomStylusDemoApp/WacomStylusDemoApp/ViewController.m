...
- (IBAction) showPopover:(UIView *)sender_I
{
	...
	mDiscoveredTable.popoverPresentationController.sourceRect = sender_I.frame;
...
- (UIModalPresentationStyle) adaptivePresentationStyleForPresentationController:(UIPresentationController *)controller_I
{
...
- (void) viewWillDisappear:(BOOL)animated_I
{
	[_dV cleanup];
}
...
- (IBAction) displayHandPositions:(UIButton *)sender_I
{
	...
	mHandPositionController.popoverPresentationController.sourceRect = sender_I.frame;
...
- (IBAction) SegControlSetHandedness:(UISegmentedControl *)sender_I
{
	switch(sender_I.selectedSegmentIndex)
	{
		case 0:
		{
...
- (IBAction) SegControlPerformAction:(UISegmentedControl *)sender_I
{
	switch(sender_I.selectedSegmentIndex)
	{
		case 0:
		{
			[self showPopover:sender_I];
			break;
		}
		case 1:
		{
...
- (void) deviceDiscovered:(WacomDevice *)device_I
{
	...
	[mDiscoveredTable addDevice:device_I];
}
...
{
	[mDiscoveredTable updateDevices:device_I];
...
{
	[mDiscoveredTable removeDevice:device_I];
